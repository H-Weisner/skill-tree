...
6. Click nodes to unlock them.
   - Only "Skill Tree Start" skills can be unlocked with no prerequisite nodes
   - "Regular Skills" and "Capstone Skills" require a connected unlocked skill to be unlocked
